...
/* BLE master switch: MQTT jkbms/bridge/cmd/ble "on"/"off". The choice is
 * persisted to NVS (default OFF) and restored at boot by the supervisor —
 * a power blip leaves the garage silent. Off drops all held links. */
