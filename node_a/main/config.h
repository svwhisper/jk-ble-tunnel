...
/* QUIET-IDLE model (owner, 2026-08-31, after garage beeping + blocked
 * direct connects proved 24x7 holds are the churn generator): a link with
 * no app and no pending work is dropped after this grace, and NOTHING
